`timescale 1ns/1ps
module memory_94x16 #(
    parameter DATA_WIDTH = 24,      // Each location stores 24 bits
    ...
    output reg [DATA_WIDTH-1:0] rd_data ,           // Data read out (24 bits)
    output match
);

    // Memory array: 94 locations × 24 bits each
