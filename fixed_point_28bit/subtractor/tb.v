...
module subtractor_tb();
    ...
    task check_result_auto;
        ...
        begin
            ...
            // Check for expected overflow (S7.20 range)
            expected_ovf = (expected_result > 127.99999904632568359375) || (expected_result < -127.99999904632568359375);
            
            // Calculate expected fixed-point value
            if (expected_ovf) begin
                if (expected_result > 0)
                    expected = 28'h7FFFFFF;  // Max positive magnitude
                else
                    expected = 28'hFFFFFFF;  // Max negative magnitude
            end else begin
    ...
    initial begin
        ...
        $display("Range: -127.99999904632568359375 to +127.99999904632568359375");
        ...
        a = real_to_fixed(55.5);    // 55.5
        b = real_to_fixed(22.25);   // 22.25
        #10;
        check_result_auto("Positive - Positive (pos result)");
        
        // Test 3: Positive - Positive (result negative)
        a = real_to_fixed(22.25);   // 22.25
        b = real_to_fixed(55.5);    // 55.5
        #10;
        ...
        a = real_to_fixed(33.5);    // 33.5
        b = real_to_fixed(-22.5);   // -22.5
        #10;
        ...
        a = real_to_fixed(44.5);    // 44.5
        b = real_to_fixed(44.5);    // 44.5
        #10;
        check_result_auto("Same numbers");
        
        // Test 9: Positive overflow
        a = real_to_fixed(120.0);    // 120.0
        b = real_to_fixed(-20.0);    // -20.0
        #10;
        ...
        a = 28'h7FFFFFF;  // Max positive (~127.9999990)
        b = 28'h0000000;  // 0.0
        #10;
        check_result_auto("Maximum Positive - Zero");
        
        // Test 12: Maximum negative - zero
        a = 28'hFFFFFFF;  // Max negative (~-127.9999990)
        b = 28'h0000000;  // 0.0
        #10;
        ...
        a = 28'h7FFFFFF;  // Max positive
        b = 28'h7FFFFFF;  // Max positive
        #10;
        check_result_auto("Max Pos - Max Pos");
        
        // Test 24: Max negative - Max negative
        a = 28'hFFFFFFF;  // Max negative
        b = 28'hFFFFFFF;  // Max negative
        #10;
